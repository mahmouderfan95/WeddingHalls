...
@section('title', 'اقسام قاعات الافراح')
@section('css')
@endsection
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">اقسام قاعات الافراح</h3>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a href="{{ route('wedding-halls-categories.create') }}" class="btn btn-primary btn-sm mb-3">ااضافة
                            قسم جديد</a>
                    </div>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered " id="companies-table"
                                                ...
                                                <tbody>
                                                    @if ($weddingHallsCategories->count() > 0)
                                                        @foreach ($weddingHallsCategories as $index => $admin)
                                                            <tr>
                                                                <td>{{ $index + 1 }}</td>
                                                                <td>{{ $admin->name ?? '-' }}</td>
                                                                <td>{{ $admin->created_at->format('d/m/Y') ?? '-' }}</td>
                                                                <td>
                                                                    <a href="{{ route('wedding-halls-categories.edit', $admin->id) }}"
                                                                    ...
                                                                    <form
                                                                        action="{{ route('wedding-halls-categories.destroy', $admin->id) }}"
                                            ...
                                            {{ $weddingHallsCategories->links('pagination::bootstrap-4') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
